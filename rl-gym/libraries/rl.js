...
(function (global) {
  ...
  DQNAgent.prototype = {
    ...
    clearEpisode: function () {
      // an episode finished, clear memory
      this.exp = []; // clear experience
      this.expi = 0; // reset where to insert

      this.t = 0; // reset time step
      ...
      this.tderror = 0; // reset the tderror
    },
    toJSON: function () {
      // save function
      var j = {};
  ...
  RecurrentReinforceAgent.prototype = {
    ...
    act: function (slist) {
      ...
      var baselineNext = R.forwardLSTM(
        this.baselineG,
        this.baselineLSTM,
        [this.nhb],
        s,
